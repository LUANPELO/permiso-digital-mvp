/* Municipios de Colombia (DIVIPOLA/DANE) — portado del proyecto principal. */
var RAW = {
  ...
  'Antioquia': [
    ...
    'Ebéjico', 'El Bagre', 'Entrerríos', 'Envigado', 'Fredonia', 'Frontino',
  ...
  'Boyacá': [
    ...
    'Pajarito', 'Panqueba', 'Pauna', 'Paya', 'Paz de Río', 'Pesca', 'Pisba',
    'Puerto Boyacá', 'Quípama', 'Ramiriquí', 'Ráquira', 'Rondón', 'Saboyá',
    'Sáchica', 'Samacá', 'San Eduardo', 'San José de Pare',
    'San Luis de Gaceno', 'San Mateo', 'San Miguel de Sema',
    'San Pablo de Borbur', 'Santa María', 'Santa Rosa de Viterbo',
    'Santa Sofía', 'Santana', 'Sativasur', 'Sativanorte', 'Siachoque',
  ...
  'Casanare': [
    'Aguazul', 'Chameza', 'Hato Corozal', 'La Salina', 'Maní', 'Monterrey',
  ...
  'Chocó': [
    ...
    'Belén de Bajirá', 'Bojayá', 'Carmen del Darién', 'Cértegui', 'Condoto',
  ...
  'Córdoba': [
    ...
    'Ciénaga de Oro', 'Cotorra', 'El Campano del San Jorge', 'Lorica',
    'Los Córdobas', 'Momil', 'Montelíbano', 'Montería', 'Moñitos',
  ...
  'Cundinamarca': [
    ...
    'Guatavita', 'Guayabal de Síquima', 'Guayabetal', 'Gutiérrez',
    ...
    'San Francisco', 'San Juan de Río Seco', 'Sasaima', 'Sesquilé',
    'Sibaté', 'Silvania', 'Simijaca', 'Soacha', 'Sopó', 'Subachoque',
    'Suesca', 'Supatá', 'Susa', 'Sutatausa', 'Tabio', 'Tausa', 'Tena',
    'Tibacuy', 'Tibirita', 'Tocaima', 'Tocancipá', 'Topaipí', 'Ubalá',
    'Ubaté', 'Ubaque', 'Une', 'Útica', 'Venecia', 'Vergara', 'Vianí',
  ...
  'Nariño': [
    ...
    'Olaya Herrera', 'Ospina', 'Pasto', 'Payán', 'Policarpa', 'Potosí',
    'Providencia', 'Puerres', 'Pupiales', 'Ricaurte', 'Roberto Payán',
    'Samaniego', 'Sandoná', 'San Bernardo', 'San Lorenzo', 'San Pablo',
    'San Pedro de Cartago', 'Santa Bárbara', 'Santacruz', 'Sapuyes',
    'Taminango', 'Tangua', 'Tumaco', 'Túquerres', 'Yacuanquer',
  ],

  'Norte de Santander': [
    'Ábrego', 'Arboledas', 'Bochalema', 'Bucarasica', 'Cáchira', 'Cácota',
    'Chinácota', 'Chitagá', 'Convención', 'Cucutilla', 'Cúcuta', 'Durania',
    ...
    'Sardinata', 'Silos', 'Teorama', 'Tibú', 'Toledo', 'Villacaro',
    'Villa del Rosario',
  ],
  ...
  'Tolima': [
    ...
    'Carmen de Apicalá', 'Casabianca', 'Chaparral', 'Coello', 'Coyaima',
    ...
    'Roncesvalles', 'Rovira', 'Sabandija', 'San Antonio', 'San Luis',
  ...
  'Valle del Cauca': [
    ...
    'Candelaria', 'Cartago', 'Cali', 'Dagua', 'El Águila', 'El Cairo',
...
window.CIUDADES = Object.keys(RAW).reduce(function(acc,depto){RAW[depto].forEach(function(n){acc.push({nombre:n,depto:depto});});return acc;},[]);
